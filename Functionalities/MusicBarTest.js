...
describe("Music Bar Teasr",
  function () {
    ...
    it("should test like song", async function () {
      return driver
    ...
    it("should test unlike song", async function () {
      return driver
      .elementById(appSelectors.LikeSongButtonID).click()
      .sleep(1000)
    ...
    it("should test like song option", async function () {
      return driver
    ...
    it("should test unlike song option", async function () {
      return driver
      .elementById(appSelectors.DropDownMenu).click()
      .sleep(1000)
      .elementById(appSelectors.LikeSongOption).click()
    ...
    it("should test next button", async function () {
      return driver
      .elementById(appSelectors.NextSongButton).click()
      .sleep(1000);
    });

    it("should test prev button", async function () {
      return driver
