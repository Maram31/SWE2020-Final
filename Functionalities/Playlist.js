...
*/
      ...
      it("Create new playlist and add songs to it then rename it", async function () {
        ...
        .elementByXPath(appSelectors.CreateNewPlaylistXpath).click()
        .sleep(1000)
        
        .elementById(appSelectors.PlaylistInputID).sendKeys('Dance')
        .sleep(1000)
       
        .elementById(appSelectors.ConfirmCreatePlaylistID).click()
        .sleep(1000)
  
        .elementById(appSelectors.AddSongsID).click()
        .sleep(1000)

        .elementByXPath(appSelectors.AddFirstSongXpath).click()
        .elementById(appSelectors.ToastID)
        .text().should.become('Added to Dance.')
        .sleep(1000)

        .elementByXPath(appSelectors.AddSecondSongXpath).click()
        .elementById(appSelectors.ToastID)
        .text().should.become('Added to Dance.')
        .sleep(1000)
        
        .elementByXPath(appSelectors.AddThirdSongXpath).click()
        .elementById(appSelectors.ToastID)
        .text().should.become('Added to Dance.')
        .sleep(1000)

        .elementByXPath(appSelectors.GoBackXpath).click()
        .sleep(1000)
        
        .elementById(appSelectors.OptionsID).click()
        .sleep(1000)

        .elementByXPath(appSelectors.RenamePlaylistXpath).click()
        .sleep(1000)

        .elementById(appSelectors.PlaylistInputID).clear()
        .sleep(1000)

        .elementById(appSelectors.PlaylistInputID).sendKeys('Jazz')
        .sleep(1000)
